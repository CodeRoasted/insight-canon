...
class InsightCanonBenchConan(ConanFile):
    ...
    def requirements(self):
        self.requires("insight_canon/1.8.2")
        self.requires("insight_semantic_github/1.8.2")
        self.requires("insight_semantic_jenkins/1.8.2")
        self.requires("insight_semantic_test_frameworks/1.8.2")
