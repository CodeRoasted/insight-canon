...
class InsightCanonBenchConan(ConanFile):
    ...
    description = (
        "InSight Canon composed benchmark harness (ADR 0024 / SP-5). Measures the tokenization "
    ...
    def requirements(self):
        self.requires("insight_canon/1.9.0")
        self.requires("insight_semantic_github/1.9.0")
        self.requires("insight_semantic_gitlab/1.9.0")
        self.requires("insight_semantic_jenkins/1.9.0")
        self.requires("insight_semantic_test_frameworks/1.9.0")
