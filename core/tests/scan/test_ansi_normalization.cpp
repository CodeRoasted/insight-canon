...
// (D-TID-11), now the FACTORY that mints `NormalizedLine` (ADR-21.D2/D3: the out-parameter strip
// form is REMOVED; the return type carries the proof that stage 1 ran).
//
