...
1. [tokenization.md](tokenization.md) — raw log line to `CanonicalEvent`: format detection, stateless template masking, arena allocator, and the public `Tokenizer` API.
