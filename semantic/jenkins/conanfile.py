...
class InsightSemanticJenkinsConan(ConanFile):
    name = "insight_semantic_jenkins"
    version = "1.8.2"
    ...
    description = (
        ...
        "semantic-grammar-2, plus the dialect format strategy (timestamper strip, [Pipeline] "
    ...
    def requirements(self):
        ...
        self.requires("insight_canon/1.8.2", transitive_headers=True, transitive_libs=True)
    ...
    def package_info(self):
        self.cpp_info.libs = ["insight_semantic_jenkins"]
        self.cpp_info.set_property("cmake_file_name", "insight_semantic_jenkins")
        self.cpp_info.set_property("cmake_target_name", "insight::semantic_jenkins")
        ...
        if malf_editable_build_dir:
            self.cpp_info.builddirs = [malf_editable_build_dir,
                                       "lib/cmake/insight_semantic_jenkins"]
        else:
            self.cpp_info.builddirs = ["lib/cmake/insight_semantic_jenkins"]
