...
class InsightSemanticGitLabConan(ConanFile):
    name = "insight_semantic_gitlab"
    version = "1.10.3"
    ...
    def package_info(self):
        self.cpp_info.libs = ["insight_semantic_gitlab"]
        self.cpp_info.set_property("cmake_file_name", "insight_semantic_gitlab")
        self.cpp_info.set_property("cmake_target_name", "insight::semantic_gitlab")
        ...
        if malf_editable_build_dir:
            self.cpp_info.builddirs = [malf_editable_build_dir,
                                       "lib/cmake/insight_semantic_gitlab"]
        else:
            self.cpp_info.builddirs = ["lib/cmake/insight_semantic_gitlab"]
