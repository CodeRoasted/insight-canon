...
module insight.semantic.github_gen;
import insight.canon.internal;
import insight.canon.api;
import insight.canon.spi;

// github_gen_provenance.cpp — the CODE TIER of `insight.semantic.github_gen`, the projected
// GitHub-Actions dialect package (ADR-17). It is a byte-for-byte twin of `github_provenance.cpp`
// apart from the module and namespace names, and the duplication is the point rather than a cost
// deferred: the projected package's code tier has to be an INDEPENDENTLY compiled definition, or
// the equivalence property `DN-17.D9` states — the two packages' code tiers agree verdict for
// verdict — would be comparing one function with itself and could not fail. Sharing one definition
// between the two modules would also make the projected package import the hand-written one, and a
// semantic package imports canon's api and spi only (ADR-17.D1).
//
// What follows is that code tier. What remains of it is the
