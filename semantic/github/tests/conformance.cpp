...
// instantiation — the ~15-line shape an external package author copies. A failing check prints its own
// verbose-on-failure diagnostic (which row, actual-vs-expected). Determinism: seedless, single-threaded;
// the kit's checks are pure functions of the manifest data.
